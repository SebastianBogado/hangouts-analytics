...
describe('Directive: rankingBarChart', function () {

  // load the directive's module and view
  beforeEach(module('hangoutsAnalyticsApp'));
  beforeEach(module('app/ranking/rankingBarChart/rankingBarChart.html'));
  ...
  beforeEach(inject(function ($rootScope, $compile) {
    ...
    scope = $rootScope.$new();
    scope.participants = [];
    element = angular.element('<ranking-bar-chart participants="participants"></ranking-bar-chart>');
  ...
  it('should have chart data initialized', inject(function () {
    ...
    expect(isolatedScope.chartMessageCount.length).toBe(1);
    expect(isolatedScope.chartMessageCount[0].length).toBe(0);
  }));
  ...
  it('should update chart data after whole participants list change', inject(function () {
    ...
    expect(isolatedScope.chartMessageCount[0].length).toBe(19);
    ...
    // Chart message count should be a list whose first element is a list of numbers
    isolatedScope.chartMessageCount[0].forEach( function (chartMessageCount) {
